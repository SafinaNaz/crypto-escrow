...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Faqs Categories</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-sm-left">Faqs Categories</h3>
                        <a class="btn btn-primary float-sm-right" href="{{url('/admin/faq-categories/create')}}">Add Faq Category</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
