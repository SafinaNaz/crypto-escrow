                ...
                <div class="col-lg-6">
                    <div class="account-form">
                        <div class="login-logo">
                            ...
                            <form action="{{ route('password.username') }}" id="email-form" name="email-form" method="POST" class="form">
                                ...
                                <div class="form-group">
                                    <input class="form-control @error('one_time_password') is-invalid @enderror" type="number" id="one_time_password" name="one_time_password" placeholder="Please Enter one time password" required />
